...
void handle_sigabrt(int sig) {
    printf("Caught SIGABRT, preventing crash.\n");
    // Handle the error here or set a flag to inform the Go code.
    // For this example, we're just using exit(1) to terminate the process with an error code.
    exit(1);
}
